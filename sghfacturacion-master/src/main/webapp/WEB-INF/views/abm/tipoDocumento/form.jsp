...
<% /* ******************************************************************************** *
	  ...
	  ******************************************************************************** */ %>
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="idDocumentoAfip">Codigo Afip</label>
					<div class="col-md-7">
						<form:input type="number" min="1" path="idDocumentoAfip" id="idDocumentoAfip" class="form-control input-sm"/>
						<div class="has-error">
